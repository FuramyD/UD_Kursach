        ...
        <div class="col-6">
            <form class="form mx-auto" @submit.prevent="publishPost()">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control" id="id" v-model="formData.id">
                </div>
                <div class="mb-2">
    ...
    export default {
        ...
        methods: {
            publishPost() {
                ...
                this.$store.dispatch('publishGroupPost', { ...this.formData, dateOfCreation: Date.now(), creatorId: +this.formData.id })
            },
            closeError() {
                this.error = ''
            }
